...
class TablaProductos
{
    ...
    public function mostrarTablaProductos()
    {
        ...
        for ($i = 0; $i < count($productos); $i++) {
            ...
            $acciones = "<button type='button' id_producto = '" . $productos[$i]["id_producto"] . "' class='btn bg-gradient-info btnImprimir'><i class='fas fa-print'></i></button> <a type='button' class='btn bg-gradient-warning btnBoton'  href = 'index.php?pagina=editar-producto&id_producto=" . $productos[$i]["id_producto"] . "' ><i class='fas fa-edit'></i></a> <button type='button' id_producto = '" . $productos[$i]["id_producto"] . "' class='btn bg-gradient-danger btnEliminarProducto'><i class='fas fa-trash'></i></button>";
